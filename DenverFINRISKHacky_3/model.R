...
model <- function(
	...
	print("Class of input train_phyloseq & test_phyloseq")
	print(class(train_phyloseq))
	print(class(test_phyloseq))
	...
	print("vegan & ecodist...")
        ...
        # Collapse raw reads on suitable phyla level, filter, inverse normal rank transformation, and pick correct columsn for t>
        # genus
